...
Detector : Modular FaceDetector (YOLO11n ONNX)
Embedder : Modular FaceRecognizer (buffalo_s - 512d)
...
KNOWN_VIDEO   = WORKSPACE_ROOT / "test_videos" / "tar1.h264"
UNKNOWN_VIDEO = WORKSPACE_ROOT / "test_videos" / "tar2.h264"
...
def main() -> None:
    ...
    detector = FaceDetector(
        model_path=str(WORKSPACE_ROOT / "yolo11-models" / "yolo11n_filtered_int8.onnx"),
