...
# WIN for Windows/Mac development; run_system automatically detects RPI on Raspberry Pi.
...
class ProximityConfig:
    ...
    # If True, detection is active even if the sensor fails; False does not suppress the error.
